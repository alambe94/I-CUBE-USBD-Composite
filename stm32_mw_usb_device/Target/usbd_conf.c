...
__weak void HAL_PCD_MspInit(PCD_HandleTypeDef *pcdHandle)
{
  ...
  {
    /* @see usb_otg.c generated by cube **/
  }
  //else
  {
    /* @see usb_otg.c generated by cube **/
...
#endif
#if (USBD_USE_MSC == 1)
    HAL_PCDEx_SetTxFiFo(hpcd_USB_OTG_PTR, (MSC_EPIN_ADDR & 0x7F), 512);
#endif
#if (USBD_USE_DFU == 1)
#endif
#if (USBD_USE_PRNTR == 1)
...
#endif
#if (USBD_USE_MSC == 1)
    HAL_PCDEx_PMAConfig((PCD_HandleTypeDef *)pdev->pData, MSC_EPIN_ADDR, PCD_SNG_BUF, pma_track);
    pma_track += 256;
