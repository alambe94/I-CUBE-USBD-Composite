...
#endif
#define USBD_PRODUCT_STRING           "STM32 RNDIS+UVC+MSC"
#define USBD_CONFIGURATION_STRING     "RNDIS+UVC+MSC Configuration"
#define USBD_INTERFACE_STRING         "RNDIS+UVC+MSC Interface"
