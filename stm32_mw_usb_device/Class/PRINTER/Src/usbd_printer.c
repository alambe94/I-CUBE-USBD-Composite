...
static uint8_t USBD_PRINTER_EP0_TxReady(USBD_HandleTypeDef *pdev);
static uint8_t USBD_PRINTER_SOF(USBD_HandleTypeDef *pdev);
static uint8_t USBD_PRINTER_IsoINIncomplete(USBD_HandleTypeDef *pdev, uint8_t epnum);
static uint8_t USBD_PRINTER_IsoOutIncomplete(USBD_HandleTypeDef *pdev, uint8_t epnum);

static uint8_t *USBD_PRINTER_GetCfgDesc(uint16_t *length);
static uint8_t *USBD_PRINTER_GetDeviceQualifierDesc(uint16_t *length);
/**
  * @}
  */
...
USBD_ClassTypeDef USBD_PRINTER_ClassDriver =
{
  USBD_PRINTER_Init,
  USBD_PRINTER_DeInit,
  USBD_PRINTER_Setup,
  USBD_PRINTER_EP0_TxReady,
  USBD_PRINTER_EP0_RxReady,
  USBD_PRINTER_DataIn,
  USBD_PRINTER_DataOut,
  USBD_PRINTER_SOF,
  USBD_PRINTER_IsoINIncomplete,
  USBD_PRINTER_IsoOutIncomplete,
  USBD_PRINTER_GetCfgDesc,
  USBD_PRINTER_GetCfgDesc,
  USBD_PRINTER_GetCfgDesc,
  USBD_PRINTER_GetDeviceQualifierDesc,
};
...
__ALIGN_BEGIN static uint8_t USBD_PRINTER_CfgDesc[USB_PRINTER_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  /**********  Descriptor of PRINTER interface 0 Alternate setting 0 **************/
...
/**
  ...
  * @retval pointer to descriptor buffer
  */
uint8_t *USBD_PRINTER_DeviceQualifierDescriptor(uint16_t *length)
{
...
/**
  * @brief  USBD_PRINTER_EP0_TxReady
...
/**
  * @brief  USBD_PRINTER_IsoINIncomplete
...
/**
  * @brief  USBD_PRINTER_IsoOutIncomplete
...
/**
  ...
  * @retval pointer to descriptor buffer
  */
uint8_t *USBD_PRINTER_GetDeviceQualifierDesc(uint16_t *length)
{
  *length = (uint16_t)sizeof(USBD_PRINTER_DeviceQualifierDesc);
