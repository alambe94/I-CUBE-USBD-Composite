...
#define USBD_PID_HS                       22655
#define USBD_PRODUCT_STRING_HS           "STM32 RNDIS+UVC+MSC"
#define USBD_CONFIGURATION_STRING_HS     "RNDIS+UVC+MSC Configuration"
#define USBD_INTERFACE_STRING_HS         "RNDIS+UVC+MSC Interface"
